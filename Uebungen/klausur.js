...
let Handytest = new Handytest()

class Handytest{
    constructor(){
this.Speicherkapazität
this.Kamera
this.Laenge
this.Marke
    }
...
Handytest.Speicherkapazität = "64gb"
Handytest.Kamera = "3 Mega Pixel"
Handytest.Laenge = "18cm"
Handytest.Marke = "Apple"

Handytest.Speicherkapazität = "32gb"
Handytest.Kamera = "2 Mega Pixel"
Handytest.Laenge = "20,1cm"
Handytest.Marke = "Samsung"
...
meineApp.get('/klausur',(browserAnfrage, serverAntwort, next) => {              

    if(browserAnfrage.signedCookies['istAngemeldetAls']){

        serverAntwort.render('klausur.ejs', {
            Speicherkapazität: Handytest.Speicherkapazität,
            Kamera: Handytest.Kamera,
            Laenge: Handytest.Laenge,
            Marke: Handytest.Marke,
